...
Gem::Specification.new do |s|
  ...
  s.files = ["AUTHORS", "COPYING", "ChangeLog", "NEWS", "README", "Rakefile", "VERSION", "ext/trace_nums.c", "ext/trace_nums.h", "ext/extconf.rb", "lib/tracelines.rb", "lib/linecache.rb", "test/rcov-bug.rb", "test/test-tracelines.rb", "test/test-lnum.rb", "test/test-linecache.rb", "test/parse-show.rb", "test/lnum-diag.rb", "test/data/for1.rb", "test/data/if6.rb", "test/data/comments1.rb", "test/data/if3.rb", "test/data/if5.rb", "test/data/begin3.rb", "test/data/end.rb", "test/data/case1.rb", "test/data/match.rb", "test/data/begin2.rb", "test/data/match3.rb", "test/data/case5.rb", "test/data/not-lit.rb", "test/data/match3a.rb", "test/data/if7.rb", "test/data/if4.rb", "test/data/case2.rb", "test/data/block2.rb", "test/data/begin1.rb", "test/data/def1.rb", "test/data/if1.rb", "test/data/class1.rb", "test/data/if2.rb", "test/data/block1.rb", "test/data/case3.rb", "test/data/each1.rb", "test/data/case4.rb", "test/short-file", "lib/trace_nums.so"]
